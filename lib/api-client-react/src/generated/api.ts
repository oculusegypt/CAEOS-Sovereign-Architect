 ...
 */
export const createWizardSession = async (wizardSessionInput: WizardSessionInput, options?: RequestInit): Promise<WizardSession> => {
...
export const getCreateWizardSessionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createWizardSession>>, TError,{data: BodyType<WizardSessionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createWizardSession>>, TError,{data: BodyType<WizardSessionInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createWizardSession>>, {data: BodyType<WizardSessionInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateWizardSessionMutationResult = NonNullable<Awaited<ReturnType<typeof createWizardSession>>>
    export type CreateWizardSessionMutationBody = BodyType<WizardSessionInput>
    export type CreateWizardSessionMutationError = ErrorType<unknown>

    /**
 * @summary Create a new CAEOS wizard session with a project description
 */
export const useCreateWizardSession = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createWizardSession>>, TError,{data: BodyType<WizardSessionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createWizardSession>>,
        TError,
        {data: BodyType<WizardSessionInput>},
        TContext
      > => {
 ...
 */
export const getWizardSession = async (id: number, options?: RequestInit): Promise<WizardSessionWithMessages> => {

  return customFetch<WizardSessionWithMessages>(getGetWizardSessionUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetWizardSessionQueryOptions = <TData = Awaited<ReturnType<typeof getWizardSession>>, TError = ErrorType<OpenaiError>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWizardSession>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWizardSessionQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getWizardSession>>> = ({ signal }) => getWizardSession(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWizardSession>>, TError, TData> & { queryKey: QueryKey }
}

export type GetWizardSessionQueryResult = NonNullable<Awaited<ReturnType<typeof getWizardSession>>>
export type GetWizardSessionQueryError = ErrorType<OpenaiError>
...
export function useGetWizardSession<TData = Awaited<ReturnType<typeof getWizardSession>>, TError = ErrorType<OpenaiError>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWizardSession>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getSendWizardMessageUrl = (id: number,) => {




  return `/api/wizard/sessions/${id}/messages`
}

/**
 * @summary Send a message in a wizard session and get a streaming CAEOS AI response
 */
export const sendWizardMessage = async (id: number,
    openaiMessageInput: OpenaiMessageInput, options?: RequestInit): Promise<unknown> => {

  return customFetch<unknown>(getSendWizardMessageUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSendWizardMessageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendWizardMessage>>, TError,{id: number;data: BodyType<OpenaiMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendWizardMessage>>, TError,{id: number;data: BodyType<OpenaiMessageInput>}, TContext> => {

const mutationKey = ['sendWizardMessage'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendWizardMessage>>, {id: number;data: BodyType<OpenaiMessageInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  sendWizardMessage(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendWizardMessageMutationResult = NonNullable<Awaited<ReturnType<typeof sendWizardMessage>>>
    export type SendWizardMessageMutationBody = BodyType<OpenaiMessageInput>
    export type SendWizardMessageMutationError = ErrorType<unknown>

    /**
 * @summary Send a message in a wizard session and get a streaming CAEOS AI response
 */
export const useSendWizardMessage = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendWizardMessage>>, TError,{id: number;data: BodyType<OpenaiMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof sendWizardMessage>>,
        TError,
        {id: number;data: BodyType<OpenaiMessageInput>},
        TContext
      > => {
      return useMutation(getSendWizardMessageMutationOptions(options));
    }
